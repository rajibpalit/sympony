...
--
-- Host: localhost    Database: Package_11000_empty_main
-- ------------------------------------------------------
...
CREATE TABLE `Control_Export_Listing` (
  ...
  `scheduled` varchar(1) NOT NULL,
  PRIMARY KEY (`id`,`domain_id`)
) ENGINE=MyISAM AUTO_INCREMENT=56867 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `Location_Featured`
--

DROP TABLE IF EXISTS `Location_Featured`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `Location_Featured` (
  `domain_id` int(11) NOT NULL,
  `location_level` int(11) NOT NULL,
  `location_id` int(11) NOT NULL,
  PRIMARY KEY (`domain_id`,`location_level`,`location_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `Location_Featured`
--

LOCK TABLES `Location_Featured` WRITE;
/*!40000 ALTER TABLE `Location_Featured` DISABLE KEYS */;
/*!40000 ALTER TABLE `Location_Featured` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `Profile` (
  ...
  `friendly_url` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'MD5(account_id)',
  `entered` datetime NOT NULL,
  `updated` datetime NOT NULL,
  `personal_message` varchar(250) COLLATE utf8_unicode_ci DEFAULT NULL,
  `twitter_account` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL,
  `facebook_uid` varchar(250) COLLATE utf8_unicode_ci NOT NULL,
  `fb_post` smallint(1) NOT NULL,
  `tw_post` smallint(1) NOT NULL,
  `usefacebooklocation` smallint(1) NOT NULL,
  `tw_oauth_token` varchar(250) COLLATE utf8_unicode_ci NOT NULL,
  `location` varchar(250) COLLATE utf8_unicode_ci NOT NULL,
  `tw_oauth_token_secret` varchar(250) COLLATE utf8_unicode_ci NOT NULL,
  `tw_screen_name` varchar(250) COLLATE utf8_unicode_ci NOT NULL,
  `profile_complete` char(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'n',
  PRIMARY KEY (`account_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `RobotsFilter` (
  ...
  `value` char(15) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
...
-- Dump completed on 2015-10-28 18:21:42
INSERT INTO Domain (id, smaccount_id, name, database_host, database_port, database_username, database_password, database_name, url, status, activation_status, created, deleted_date, article_feature, banner_feature, classified_feature, event_feature, subfolder) VALUES ('1', '1', 'pmalink.org', 'localhost', '3306', 'pmalink', '49nxcY1A', 'pmalink_domain_1', 'pmalink.org', 'A', 'A', '0000-00-00', '0000-00-00', 'on', 'on', 'on', 'on', NULL);
INSERT INTO SMAccount (id, updated, entered, username, password, permission, iprestriction, faillogin_count, faillogin_datetime, name, phone, email, complementary_info, active) VALUES (1, '2015-08-19 22:41:42', '0000-00-00 00:00:00', 'arcalogin@arcasolutions.com', 'cc9141500563b2e141307f57581e21ae', '8380383', '*', 0, '0000-00-00 00:00:00', '', '', '', '23b7c615d4edd4cf7d858ab5fd667928', 'y');
