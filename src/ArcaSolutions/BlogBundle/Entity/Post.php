 ...
 * Post
 *
 * @ORM\Table(name="Post", uniqueConstraints={@ORM\UniqueConstraint(name="legacy_id", columns={"legacy_id"})}, indexes={@ORM\Index(name="title", columns={"title"}), @ORM\Index(name="status", columns={"status"}), @ORM\Index(name="friendly_url", columns={"friendly_url"}), @ORM\Index(name="entered", columns={"entered"}), @ORM\Index(name="updated", columns={"updated"}), @ORM\Index(name="fulltextsearch_keyword", columns={"fulltextsearch_keyword"}), @ORM\Index(name="fulltextsearch_where", columns={"fulltextsearch_where"})})
 * @ORM\Entity
 */
class Post
{
    ...
    /**
     * @ORM\ManyToMany(targetEntity="ArcaSolutions\BlogBundle\Entity\Blogcategory")
