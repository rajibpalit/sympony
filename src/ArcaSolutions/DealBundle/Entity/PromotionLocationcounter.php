 ...
 *
 * @ORM\Table(name="Promotion_LocationCounter")
 * @ORM\Entity(repositoryClass="ArcaSolutions\DealBundle\Repository\PromotionLocationcounterRepository")
 */
class PromotionLocationcounter
{
    /**
     * @var integer
     *
     ...
     * @return PromotionLocationcounter
     */
