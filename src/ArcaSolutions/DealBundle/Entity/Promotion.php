 ...
 * Promotion
 *
 * @ORM\Table(name="Promotion", indexes={@ORM\Index(name="account_id", columns={"account_id"}), @ORM\Index(name="start_date", columns={"start_date"}), @ORM\Index(name="end_date", columns={"end_date"}), @ORM\Index(name="name", columns={"name"}), @ORM\Index(name="random_number", columns={"random_number"}), @ORM\Index(name="listing_level", columns={"listing_level"}), @ORM\Index(name="listing_id", columns={"listing_id", "listing_status"}), @ORM\Index(name="fulltextsearch_keyword", columns={"fulltextsearch_keyword"}), @ORM\Index(name="fulltextsearch_where", columns={"fulltextsearch_where"})})
...
class Promotion
{
     ...
     * @var string
     *
     * @ORM\Column(name="listing_zip5", type="string", length=10, nullable=false)
     */
    private $listingZip5 = '0';
    ...
    /**
     * @ORM\OneToOne(targetEntity="ArcaSolutions\ListingBundle\Entity\Listing", inversedBy="deal")
     ...
     * Set listingZip5
     *
     * @param string $listingZip5
     * @return Promotion
     */
    public function setListingZip5($listingZip5)
    {
        $this->listingZip5 = $listingZip5;
     ...
     * @return string
     */
    public function getListingZip5()
    {
        return $this->listingZip5;
    }
