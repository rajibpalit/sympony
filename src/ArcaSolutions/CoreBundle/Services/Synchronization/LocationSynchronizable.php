...
class LocationSynchronizable extends BaseSynchronizable
{
    ...
    function __construct(ContainerInterface $container)
    {
        ...
        $this->activeLocations = $this->container->get("filter.location")->getEnabledLocations();
     ...
     */
    public function generateAllLocations()
    {
        ...
        while ($location = array_pop($firstLevelLocations)) {
            $this->generateTree($location, 0, null);
        }
    }
     ...
     * @return string
     */
    public function generateTree($element, $i, $parentId = null)
    {
        $id = $element->getId();
        ...
        if ($childLevel) {
            ...
            foreach ($children as $child) {
                $subLocationId[] = $this->generateTree($child, $i, $elasticId);
            }
        }
