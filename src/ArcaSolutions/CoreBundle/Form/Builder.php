    ...
    public function generate(Form $form, array $fields = null)
    {
        ...
        foreach ($fields as $field) {
            ...
            $options = [
                ...
                'constraints' => $field['required'] == 'true' ? new NotBlank(['message' => 'The field is required']) : [],
            ];
            ...
            if (!is_array($field['values'])) {
                ...
                $form->add('custom_'.Inflector::friendly_title($field['values']), $type, $options);
            } else {
                $choices = [];
                ...
                $form->add('custom_'.Inflector::friendly_title($field['title']), 'choice', $options);
            }
        }
    }
