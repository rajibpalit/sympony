 ...
 * ReportEventMonthly
 *
 * @ORM\Table(name="Report_Event_Monthly")
 * @ORM\Entity(repositoryClass="ArcaSolutions\ReportsBundle\Repository\ReportEventMonthlyRepository")
 */
class ReportEventMonthly
{
    /**
     * @var integer
     *
