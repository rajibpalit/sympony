 ...
 * ReportPostMonthly
 *
 * @ORM\Table(name="Report_Post_Monthly")
 * @ORM\Entity(repositoryClass="ArcaSolutions\ReportsBundle\Repository\ReportPostMonthlyRepository")
 */
class ReportPostMonthly
{
    /**
     * @var integer
     *
