 ...
 * Listing
 *
 * @ORM\Table(name="Listing", indexes={@ORM\Index(name="title", columns={"title"}), @ORM\Index(name="random_number", columns={"random_number"}), @ORM\Index(name="country_id", columns={"location_1"}), @ORM\Index(name="state_id", columns={"location_2"}), @ORM\Index(name="region_id", columns={"location_3"}), @ORM\Index(name="account_id", columns={"account_id"}), @ORM\Index(name="renewal_date", columns={"renewal_date"}), @ORM\Index(name="status", columns={"status"}), @ORM\Index(name="promotion_id", columns={"promotion_id"}), @ORM\Index(name="latitude", columns={"latitude"}), @ORM\Index(name="longitude", columns={"longitude"}), @ORM\Index(name="level", columns={"level"}), @ORM\Index(name="city_id", columns={"location_4"}), @ORM\Index(name="area_id", columns={"location_5"}), @ORM\Index(name="zip_code", columns={"zip_code"}), @ORM\Index(name="friendly_url", columns={"friendly_url"}), @ORM\Index(name="listingtemplate_id", columns={"listingtemplate_id"}), @ORM\Index(name="image_id", columns={"image_id"}), @ORM\Index(name="thumb_id", columns={"thumb_id"}), @ORM\Index(name="idx_fulltextsearch_keyword", columns={"fulltextsearch_keyword"}), @ORM\Index(name="idx_fulltextsearch_where", columns={"fulltextsearch_where"}), @ORM\Index(name="updated_date", columns={"updated"}), @ORM\Index(name="clicktocall_number", columns={"clicktocall_number"}), @ORM\Index(name="Listing_Promotion", columns={"level", "promotion_id", "account_id", "title", "id"})})
...
class Listing
{
     ...
     * @var integer
     *
     * @ORM\OneToOne(targetEntity="Promotion", mappedBy="promotion_id")
     ...
     * @var string
     *
     * @ORM\Column(name="facebook_page", type="string", length=100, nullable=false)
     */
     ...
     * @var boolean
     *
     * @ORM\Column(name="reminder", type="boolean", nullable=false)
     */
    private $reminder = '0';
     ...
     * @var string
     *
     * @ORM\Column(name="video_description", type="string", length=255, nullable=false)
     */
     ...
     * @var string
     *
     * @ORM\Column(name="hours_work", type="text", nullable=false)
     */
    private $hoursWork;
     ...
     * @var string
     *
     * @ORM\Column(name="backlink_url", type="string", length=255, nullable=false)
     */
    private $backlinkUrl;
     ...
     * @var \DateTime
     *
     * @ORM\Column(name="last_traffic_sent", type="date", nullable=false)
     */
    ...
    /**
     * @ORM\OneToOne(targetEntity="ArcaSolutions\DealBundle\Entity\Promotion", mappedBy="listing")
     */
    private $deal;

    /**
     * @ORM\ManyToMany(targetEntity="ArcaSolutions\ListingBundle\Entity\EditorChoice")
     * @ORM\JoinTable(name="Listing_Choice",
     *      joinColumns={@JoinColumn(name="listing_id", referencedColumnName="id")},
     *      inverseJoinColumns={@JoinColumn(name="editor_choice_id", referencedColumnName="id")}
     *      )
     */
    private $choices;

    /**
     * @ORM\ManyToMany(targetEntity="ArcaSolutions\ListingBundle\Entity\ListingCategory")
