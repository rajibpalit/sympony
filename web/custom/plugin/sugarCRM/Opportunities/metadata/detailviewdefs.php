...
$viewdefs['Opportunities']['DetailView'] = array(
    'templateMeta' => array('form' => array('buttons'=>array('EDIT', 'DUPLICATE', 'DELETE',
                                                         array('customCode'=>'<input title="{$APP.LBL_DUP_MERGE}" ' .
                                                         		...
                                                         		'type="submit">'),
														array('customCode'=>'<input title="{$MOD.LBL_EDIRECTORY_1}" onclick="window.open(\'http://demodirectory-develop.basecode.arcasolutions.com/sugar/0c02b2bc03ad87c8fe01fdbcf5907618/{$fields.id.value}/\', \'DemodirectoryDevelop\',\'menubar=0,resizable=1,width=1100,height=600,location=0,scrollbars=1,status=1\');" name="button" value="{$MOD.LBL_EDIRECTORY_1}" type="button">'),)),
       						'maxColumns' => '2',
                            'widths' => array(
