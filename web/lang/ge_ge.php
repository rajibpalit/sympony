<?
	...
	define("LANG_MSG_CLICK_TO_ADD_BACKLINK", "Markieren Sie dieses Kästchen, um den Backlink dieser Liste hinzufügen");
	//Backlink URL
	...
	//Add description
	define("LANG_LABEL_GAMEFY_DESC", "Beschreibung");
	//Add photos or video
	define("LANG_LABEL_GAMEFY_MEDIA", "Fotos oder Video hinzufügen");
	//Add details
	define("LANG_LABEL_GAMEFY_ADDITIONAL", "Details hinzufügen");
	...
	define("LANG_LABEL_TUTORIAL_TOUR-FACEBOOK", "Hat Ihr Unternehmen eine Facebook-Seite? Geben Sie hier, um die Facebook-Pinnwand Widget im Eintrag-Detailseite zu zeigen.");
