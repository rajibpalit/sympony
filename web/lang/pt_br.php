<?
	...
	define("LANG_MSG_CLICK_TO_ADD_BACKLINK", "Selecione esta caixa para adicionar backlink a esta empresa.");
	//Backlink URL
    ...
    //Your Name
    define("LANG_LABEL_PROFILE_DISPLAYNAME", "Seu Nome");
    //Personal Page
	...
	//Contact Us
	define("LANG_NOTIFY_CONTACTUS", "Fale Conosco");
	//Event Notification
	...
	//Talk to Us
	define("LANG_LEAD_TALKTOUS", "Fale Conosco");
	//Your first name
	...
	//Add description
	define("LANG_LABEL_GAMEFY_DESC", "Adicione descrição");
	//Add photos or video
	define("LANG_LABEL_GAMEFY_MEDIA", "Adicione fotos ou video");
	//Add details
	define("LANG_LABEL_GAMEFY_ADDITIONAL", "Adicione mais detalhes");
	...
	define("LANG_LABEL_TUTORIAL_TOUR-FACEBOOK", "A sua empresa tem uma página no Facebook? Informe a URL aqui para mostrar o mural do Facebook na página de detalhes da empresa.");
