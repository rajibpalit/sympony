<?
	...
	define("LANG_MSG_CLICK_TO_ADD_BACKLINK", "Seleziona questa casella per aggiungere il backlink per questa listing");
	//Backlink URL
	...
	//Add description
	define("LANG_LABEL_GAMEFY_DESC", "Aggiungi description");
	//Add photos or video
	define("LANG_LABEL_GAMEFY_MEDIA", "Aggiungi foto o il video");
	//Add details
	define("LANG_LABEL_GAMEFY_ADDITIONAL", "Aggiungi dettagli");                         
	...
	define("LANG_LABEL_TUTORIAL_TOUR-FACEBOOK", "La tua azienda ha una pagina di Facebook? Digita qui per mostrare il widget bacheca di Facebook sulla pagina di dettaglio del listing.");
