<?
	...
	define("LANG_MSG_CLICK_TO_ADD_BACKLINK", "Check this box to add backlink for this ".LISTING_FEATURE_NAME);
	//Backlink URL
	...
	define("LANG_MSG_LISTING_BACKLINKS_ERROR", "You have no ".LISTING_FEATURE_NAME_PLURAL." to add backlink yet.");
	//Backlink preview
    ...
    //Your Name
    define("LANG_LABEL_PROFILE_DISPLAYNAME", "Your Name");
    //Personal Page
	...
	define("LANG_NOTIFY_ITEMS_3", "and needs to be revised by you.");
	//Banner Notification
	...
	define("LANG_NOTIFY_TRANSACTION_1", "A transaction was made and needs to be revised by you.");
	//Transaction Info:
    ...
    //Add description
    define("LANG_LABEL_GAMEFY_DESC", "Add description");
    //Add photos or video
    define("LANG_LABEL_GAMEFY_MEDIA", "Add photos or videos");
    //Add details
    define("LANG_LABEL_GAMEFY_ADDITIONAL", "Add details");
	...
	//Does your business have a Facebook page? Type it here to show the Facebook wall widget on the item's detail page.
	define("LANG_LABEL_TUTORIAL_TOUR-FACEBOOK", "Does your business have a Facebook page? Type it here to show the Facebook wall widget on the ".LISTING_FEATURE_NAME."'s detail page.");
