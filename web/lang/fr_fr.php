<?
	...
	define("LANG_MSG_CLICK_TO_ADD_BACKLINK", "Cochez cette case pour ajouter le backlink pour cette liste");
	//Backlink URL
	...
	define("LANG_LABEL_ANSWER1", "Ajout d'un lien vers votre site pointant vers celui-ci, augmente la pertinence de ce site et à son tour la pertinence de votre liste.");
	//What's in it for me?
	...
	define("LANG_MSG_LISTING_BACKLINKS_ADDED", "Backlink d'ajouter à vos liste!");
	//You have no listings to add backlink yet.
	define("LANG_MSG_LISTING_BACKLINKS_ERROR", "Vous n'avez pas d'liste pour l'ajouter backlink pour le moment.");
	//Backlink preview
	...
	//Add description
	define("LANG_LABEL_GAMEFY_DESC", "Ajouter la description");
	//Add photos or video
	define("LANG_LABEL_GAMEFY_MEDIA", "Ajouter des photos ou vidéo");
	//Add details
	define("LANG_LABEL_GAMEFY_ADDITIONAL", "Ajouter des détails");                            
	...
	define("LANG_LABEL_TUTORIAL_TOUR-FACEBOOK", "Votre entreprise at-une page Facebook? Tapez ici pour montrer le widget mur Facebook sur la page de détail de l'liste.");
