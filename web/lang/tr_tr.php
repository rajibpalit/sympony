<?
	...
	define("LANG_MSG_CLICK_TO_ADD_BACKLINK", "Bu liste için backlink eklemek için bu kutuyu işaretleyin");
	//Backlink URL
	...
	//Add description
	define("LANG_LABEL_GAMEFY_DESC", "Açıklama ekle");
	//Add photos or video
	define("LANG_LABEL_GAMEFY_MEDIA", "Fotoğraf ya da video eklemek");
	//Add details
	define("LANG_LABEL_GAMEFY_ADDITIONAL", "Ayrıntıları ekle");
	...
	//Does your business have a Facebook page? Type it here to show the Facebook wall widget on the Liste's detail page.
	define("LANG_LABEL_TUTORIAL_TOUR-FACEBOOK", "Iş bir Facebook sayfası var mı? Liste ayrıntı sayfasındaki Facebook duvar widget'ı göstermek için burada yazın.");
