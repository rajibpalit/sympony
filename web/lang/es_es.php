<?
	...
	define("LANG_JS_FAVORITES_ADDED", "Este elemento esta ya a tus favoritos.<br />Puedes ver tus favoritos en tu página de perfil.");
	//Wait...
    ...
    define("LANG_LABEL_REVIEW_RATES", "tasas este [item] con");
    //Did you find this review helpful?
    define("LANG_LABEL_REVIEW_HELPFUL", "¿Te ha resultado útil esta calificacione?");
    //Blog Comment
	...
	define("LANG_PASSWORD_NOT_CHANGED", "Contraseña no se cambia.");
	//Create Password
	...
	//You refined by...
	define("LANG_LABEL_REFINEDBY", "Usted filtrou por ...");
	//Remove all
	...
	define("LANG_LABEL_ATTACH_ADDITIONAL_FILE_TIP", "¿Quieres agregar más información acerca de tu artículo? Además de su galería de imágenes, puede cargar un archivo adicional con la información adicional aquí");
	//Fill in this field if your URL is too long. Example: "www.example.com" can be shown as "Example".
	define("LANG_LABEL_DISPLAY_URL_TIP", "Rellene este campo si el URL es demasiado larga. Ejemplo: \"www.ejemplo.com\" se puede mostrar como \"Ejemplo\".");
	//Enable monthly e-mail to listing owners that includes their stats and reviews.
	define("LANG_LABEL_NOTIFY_TRAFFIC_TIP", "Habilitar correo electrónico mensual a los propietarios listado que incluye sus estadísticas y comentarios.");
    ...
    //Good to know
    define("LANG_LABEL_GOODKNOW", "Es bueno saber");
    //Make a reservation
    define("LANG_LABEL_RESERVATION", "Hacer una reserva");
	//Attention
	...
	//Time left to buy
	define("LANG_LABEL_PROMOTION_TIMELEFT", "Tiempo para comprar");
	//Printable Deal
	...
	define("LANG_MSG_EXTRA_CATEGORIES_COST", "Las categorías extras cuestan un");
	//additional
	...
	//Download [item] Menu
	define("LANG_LISTING_DOWNLOADMENU", "Descarga el Menú de [item]");
	...
	define("LANG_REVIEWBETHEFIRST", "¡Sea el primero en calificar!");
	//Offered by
	...
	//Featured Events
	define("LANG_FEATURED_EVENT", "Eventos Presentados");
	//Featured Event
	define("LANG_FEATURED_EVENT_SING", "Evento Presentado");
	//Featured Classifieds
	define("LANG_FEATURED_CLASSIFIED", "Clasificados Presentados");
	//Featured Classified
	define("LANG_FEATURED_CLASSIFIED_SING", "Clasificado Presentado");
	//Featured Articles
	define("LANG_FEATURED_ARTICLE", "Artículos Presentados");
	//Featured Article
	define("LANG_FEATURED_ARTICLE_SING", "Artículo Presentado");
	//Featured Listings
	define("LANG_FEATURED_LISTING", "Listados Presentados");
	//Featured Listing
	define("LANG_FEATURED_LISTING_SING", "Listado Presentado");
	//Featured Deals
	define("LANG_FEATURED_PROMOTION", "Ofertas Presentadas");
	//Featured Deal
	define("LANG_FEATURED_PROMOTION_SING", "Oferta Presentada");
	//View all articles
	...
	//Listing with a deal
	define("LANG_LABEL_VIEW_LISTINGDEAL", "Listado com oferta");
	//Most Read
	...
	define("LANG_ALREADYHAVEACCOUNT", "¿Ya es miembro?");
	//No, I'm a New User.
	...
	define("LANG_ACCOUNTOPENIDUSER", "O ingresar con tu cuenta de OpenID");
	...
	//"Extra categories cost an" additional [LEVEL_CATEGORY_PRICE] each. Be seen!
	define("LANG_CATEGORIES_PRICEDESC1", "Las categorías extras cuestan un");
	//Extra categories cost an "additional" [LEVEL_CATEGORY_PRICE] each. Be seen!
    ...
    define("LANG_ADVERTISE_PAYMENT_TIP2", "Imprima su factura y terminar su orden.");
	...
	define("LANG_EVENTINFO_TIP", "¿Qué quieres que llame a su evento?");
    //What do you want to call your classified?
	define("LANG_CLASSIFIEDINFO_TIP", "¿Qué quieres que llame a su clasificado?");
    //What do you want to call your article?
	define("LANG_ARTICLEINFO_TIP", "¿Qué quieres que llame a su artículo?");
    //What do you want to call your banner?
	define("LANG_BANNERINFO_TIP", "¿Qué quieres que llame a su banner?");
	...
	define("LANG_CLAIM_SIGNUP", "Para reclamar este listado, sólo tienes que entrar con datos de su cuenta o crear una nueva cuenta.");
	//Listing Type
	...
	define("LANG_MSG_CONTACT_TYPE_CODE", "¡Escriba correctamente el código o marcar la casilla si está disponible.");
	...
	//Backlink
	define("LANG_ADVERTISE_LIST_BACKLINK", "Backlink");
	//Deal
	...
	//Detail Description
	define("LANG_ADVERTISE_LIST_LONG_DESCRIPTION", "Descripción extensa");
	//Photo Gallery
	...
	//Contact E-mail
	define("LANG_ADVERTISE_LIST_CONTACT_EMAIL", "E-mail de Contacto");
	//Event Time
	...
	define("LANG_CLICK_ORDERRENEWALDESC", "Haga clic aquí para ordenar por renovación descendente");
	//Click here to order by ascending renewal date
	define("LANG_CLICK_ORDERRENEWALASC", "Haga clic aquí para ordenar por renovación ascendente");
	...
	//Check this box to add backlink for this listing
	define("LANG_MSG_CLICK_TO_ADD_BACKLINK", "Marque esta casilla para añadir el backlink de este listado");
	//Backlink URL
	...
	//You have no listings to add backlink yet.
    ...
    define("LANG_MSG_ACCOUNT_ACTIVATED", "¡Cuenta activado con éxito!");
    ...
    define("LANG_MSG_PROCCESS_AGAIN", "Hacer que el proceso de nuevo con menos elementos.");
	...
	define("LANG_MSG_REVIEW_SUCCESS_DELETED", "Calificacione ha eliminado correctamente.");
	//No reviews found!
    ...
    define("LANG_PROFILE_WELCOME", "¡Gracias por tú inscripción!");
    ...
    //Your OpenID
    define("LANG_LABEL_PROFILE_YOUROPENID", "Tu OpenID");
    //Login
    ...
    define("LANG_LABEL_PROFILE_ACTIVATED", "Una vez que haya creado su cuenta a través de un sistema externo, se activa automáticamente. Haga caso omiso de este mensaje.");
    ...
    //Your Name
    define("LANG_LABEL_PROFILE_DISPLAYNAME", "Nombre");
    //Personal Page
    ...
    define("LANG_LABEL_ACCOUNT_USERNAME_TIP", "Usted puede cambiar su dirección de e-mail de acceso en cualquier momento. Este es también el correo electrónico de contacto que utilizamos para llegar a usted.");
    //Activated
    ...
    define("LANG_LABEL_ACTIVATEEMAIL_SENT", "Su e-mail de activación ha sido enviado. Por favor, revise su bandeja de entrada.");
	...
	//Deals redeemed
	define("LANG_LABEL_DEAL_BOUGHT", "Ofertas compradas");
	//Deals left
	...
	define("LANG_CLICKTOCALL_TIP2", "Click-to-call permite a los clientes conectarse una llamada entre el teléfono y el de ellos con el clic de un botón. Para activarlo, pulse el botón de abajo y se hará una llamada de prueba.");
	...
	define("LANG_LABEL_SEARCHKEYWORDTIP_POST", "Palabra o post título");
	//Archive
	...
	define("LANG_COMMENT_EMPTY_WEBSITE", "Por favor escriba un e-mail válido.");
	...
	define("LANG_MSG_REPLY_SUCCESSFULLY_POSTED", "¡Respuesta se ha publicado correctamente!");
	//Your reply has been submitted for approval.
	define("LANG_MSG_REPLY_SENT_TO_APPROVE", "Tu respuesta ha sido presentado para su aprobación.");
	//Content
	...
	//Transaction Info:
	define("LANG_NOTIFY_TRANSACTION_2", "Transacción Info:");
	//Transaction Time
	define("LANG_NOTIFY_TRANSACTION_3", "Fecha de Transacción");
	//Gateway
	define("LANG_NOTIFY_TRANSACTION_4", "Forma de Pago");
	//(prices amount are per installments)
	define("LANG_NOTIFY_TRANSACTION_5", "(cantidad precios son por plazos)");
    ...
    //has a new comment.
    define("LANG_NOTIFY_NEWCOMMENT_3", "ha recibido un comentario nuevo.");
    //wrote
    ...
    //You can review the log here
    define("LANG_NOTIFY_IMPORTLISTING_2", "Usted puede revisar la historia aquí");
    //Event Import Notification
    define("LANG_NOTIFY_IMPORTEVENT", "Notificación de Importación de Evento");
    ...
    //Help Request
    define("LANG_NOTIFY_MEMBERSHELP", "Petición de Ayuda");
	...
	define("LANG_NOTIFY_NEWLEAD", "Usted recibió un nuevo lead a través del formulario de consulta. Para ver el lead, siga el siguiente enlace.");
	...
	define("LANG_MOBILE_GRAB_APP_IPHONE", "Coge la App eDirectory para iPhone.");
	//In Google Play
	define("LANG_MOBILE_GRAB_APP_ANDROID", "En Google Play");
	//Available on the
	define("LANG_MOBILE_APP_STORE", "Disponible en la");
	//ANDROID APP ON
	define("LANG_MOBILE_APP_ANDROID", "ANDROID APP DE");
    //Recently added listings
    define("LANG_MOBILE_RECENT_LISTINGS", "Listados reciente");
    //View full site
    define("LANG_MOBILE_FULLSITE", "Ver sitio completo");
    //Download App
    define("LANG_MOBILE_DOWNLOAD_APP", "Descarga la App");
    //Use the following code:
    define("LANG_MOBILE_DEAL_USECODE", "Utilice el siguiente código:");
    //REDEEMED
    define("LANG_MOBILE_DEAL_REDEEMED", "VALIDADA");
    //Please login to redeem
    define("LANG_MOBILE_DEAL_LOGIN", "Por favor, entra para validar.");
    
    # ----------------------------------------------------------------------------------------------------
	# ARCAMAILER
	# ----------------------------------------------------------------------------------------------------
    //Sign up for our Newsletter
    define("LANG_ARCAMAILER_SIGNUP", "Suscríbase a nuestro Boletín");
    //Subscribe
    define("LANG_ARCAMAILER_SUBSCRIBE", "Suscríbase");
	//Subscribe to our monthly newsletter, no spam, just product updates.
	define("LANG_ARCAMAILER_SUBSCRIBE_TIP", "Suscríbete a nuestro boletín mensual, no spam, sólo actualizaciones de productos.");
    //Please, type your name and e-mail.
    define("LANG_ARCAMAILER_SUBSCRIBEERROR", "Por favor, escriba su nombre y correo electrónico.");
    ...
    define("LANG_CONFIRM_CHANGE_LEVEL", "Cambiar perderá los cambios no guardados realizados en este formulario.");
    ...
    //Featured Deal
    define("LANG_LABEL_FEATURED_DEAL", "Oferta del Día");
    //Popular Reviews
    define("LANG_LABEL_POPULAR_REVIEW", "Calificaciones Populares");
	//Helpful Reviews
    ...
    define("LANG_LABEL_FILTER_VALID_FOR_MORE_THAN_2_DAYS", "Válido para más de 2 días");
    //Valid for more than a week
    define("LANG_LABEL_FILTER_VALID_FOR_MORE_THAN_A_WEEK", "Válido para más de una semana");
	//filter
    ...
    define("LANG_LABEL_FILTER_MAP_MORE_THAN_1000_RESULTS", "Ver mapa sólo está disponible para los conjuntos de resultados con menos del [MAX_MARKERS] artículos. Utilice los filtros para refinar"); 
    //No Matches
    define("LANG_LABEL_FILTER_NO_MATCHES", "Partidos sin");
    //Clear Filters
    define("LANG_LABEL_FILTER_SHOW_ORIGINAL_SEARCH", "Mostrar original de la búsqueda");
	...
	define("LANG_MSG_CLICK_TO_VIEW_THIS_ITEM_LEADS", "Haz clic aquí para ver este elemento leads");
	//Manage Leads
	define("LANG_MANAGE_LEADS", "Gestione Leads");
	//No records found.
	define("LANG_NORECORD", "No se encontró el registro.");
	//Forward
	define("LANG_LABEL_FORWARD", "Adelante");
	//Lead successfully deleted!
	define("LANG_LEAD_SUCCESSDELETED", "Lead se ha eliminado correctamente!");
	//Lead successfully replied!
	define("LANG_LEAD_REPLIED", "Lead respondió correctamente!");
	//Lead successfully forwarded!
	define("LANG_LEAD_FORWARDED", "Lead enviado correctamente!");
	//Please type a message.
	define("LANG_LEAD_TYPEMESSAGE", "Por favor, escriba un mensaje.");
	//New lead received by
	define("LANG_LEAD_RECEIVED", "Nueva lead recibido por");
	//Replied
	define("LANG_LEAD_REPLIED_ICO", "Respondió");
	//Forwarded
	define("LANG_LEAD_FORWARDED_ICO", "Remitió");
	//Replied and Forwarded
	define("LANG_LEAD_REPLIED_FORWARDED_ICO", "Respondió [dater] y Remitió [datef]");
	//Talk to Us
	...
	//Your email, please?
	define("LANG_LEAD_EMAIL", "Tu email, por favor?");
	...
	define("LANG_LEAD_TYPE_NAME", "Por favor escriba su nombre y apellido.");
	//Thank you, we will be in touch shortly.
	define("LANG_LEAD_THANKYOU", "Gracias, estaremos en contacto en breve.");
	//New Enquire
	define("LANG_LEAD_ENQUERY", "Nueva Consulta");
	//General Lead
	define("LANG_GENERAL_LEAD", "Lead General");

	# ----------------------------------------------------------------------------------------------------
	# LOG IN / SIGN UP / MEMBERS
	# ----------------------------------------------------------------------------------------------------
	//Or log in using your e-mail address
	define("LANG_OR_SIGNINEMAIL", "o inicia sesión con tu e-mail");
	//Or sign up using your e-mail address
	define("LANG_OR_SIGNUPEMAIL", "o registrate con tu e-mail");
    ...
    define("LANG_LABEL_ALREADY_MEMBER", "Ya eres usuario - Ingrese aquí.");
	//Reference
	...
	define("LANG_HELP_MESSAGE", "¿Tienes una pregunta o algo le pegan en? Envíenos un mensaje. Nos pondremos en contacto con usted tan pronto como nos sea posible.");
	//Add a new content
	...
	define("LANG_ADD_NEW_CONTENT2_TIP", "Añada su empresa hoy en día, es rápido y sencillo!");
	//Remove
	define("LANG_LABEL_REMOVE", "Eliminar");
	//View on Website
	define("LANG_LABEL_VIEW_LIVE", "Ver en el Sitio Web");
	//Preview
	define("LANG_LABEL_PREVIEW", "Avance");
	//Expires in
	...
	//See all leads
	define("LANG_LABEL_SEE_LEADS", "Ver todos los leads");
	//Statistics
	...
	//Listing Completion
    define("LANG_LABEL_LISTING_COMPLETION", "Informações do Listado");
    //Event Completion
    define("LANG_LABEL_EVENT_COMPLETION", "Informações do Evento");
    //Classified Completion
    define("LANG_LABEL_CLASSIFIED_COMPLETION", "Informações do Clasificado");
    //Article Completion
    define("LANG_LABEL_ARTICLE_COMPLETION", "Informações do Artículo");
	//Deal Completion
    define("LANG_LABEL_PROMOTION_COMPLETION", "Informações da Oferta");
    //You're not quite done with your item.
    define("LANG_LABEL_GAMEFY_TIP", "No has terminado con su ítem.");
	//What are you looking for today?
	define("LANG_LABEL_PROFILE_TIP1", "¿Qué estás buscando hoy?");
	...
	define("LANG_LABEL_PROFILE_TIP2", "Gracias por ser parte de ".EDIRECTORY_TITLE.". Únete a nuestra comunidad, dando su opinión y evaluación de sus listados favoritos.");
	//Oh wait...
	define("LANG_LABEL_PROFILE_TIP3", "Lo sentimos...");
	...
	define("LANG_LABEL_PROFILE_TIP4", "Este usuario no tiene actividad en nuestro portal todavía.<br>No se preocupe. Usted puede unirse a nuestra comunidad, dando su opinión y evaluación de sus listados favoritos.");
	//Rated
	define("LANG_LABEL_RATED", "Evaluó");
	//Commented
	define("LANG_LABEL_COMMENTED", "Comentó");
	//Redeemed deal
	define("LANG_LABEL_REDEEMED", "Redimido la oferta");
	//Your redeem code is 
	...
	define("LANG_LABEL_NEW_LEAD", "Usted recibió [x] nuevo lead");
	//You received [x] new leads
	define("LANG_LABEL_NEW_LEADS", "Usted recibió [x] nuevos leads");
	...
	define("LANG_HOLDER_BANNERTITLE", "Introduzca el nombre de tu banner aquí.");
	...
	define("LANG_HOLDER_ARTICLETITLE", "Introduzca el nombre de tu artículo aquí.");
	...
	define("LANG_HOLDER_EVENTDESCRIPTION", "Presentar el evento al público de una manera clara y eficiente. Describir los principales aspectos más destacados y las características que atraigan a la gente.");
	...
	define("LANG_HOLDER_CLASSIFIEDDESCRIPTION", "Presente clasifican al público de una manera clara y eficiente. Describir los principales aspectos más destacados y las características que harán que la gente quiere comprar su producto / servicio.");
	//Resumo do artigo.
	define("LANG_HOLDER_ARTICLESUMMARY", "Resumen del artículo.");
	//Type your keyword. Press 'Tab' or 'Enter' on your keyboard to confirm.
	define("LANG_HOLDER_KEYWORDS", "Ingresa la palabra clave y pulse 'Tab' para confirmarlo.");
	//Utilize este campo para destacar algumas características que a sua empresa tem a oferecer. Digite um item por linha.
	define("LANG_HOLDER_FEATURES", "Utilice este campo para poner de relieve algunas de las características que su empresa tiene para ofrecer. Introduce un elemento por línea.");
	//Você tem um código de desconto? Digite-o aqui.
	define("LANG_HOLDER_DISCOUNTCODE", "Usted tiene un código de descuento? Ingrese aquí.");
	...
	define("LANG_HOLDER_PROMOTIONCONDITIONS", "Escriba aquí los términos y condiciones para canjear tu trato.");
	//Não foi possível carregar o vídeo. Por favor, verifique a URL do vídeo e tente novamente.
	define("LANG_VIDEO_NOTFOUND", "No se puede cargar el vídeo. Por favor, compruebe la URL del video y vuelva a intentarlo.");
	//Você pode selecionar até [max] categorias.
	define("LANG_SELECTMAX_CATEGORIES", "Puede seleccionar hasta [max] categorías.");
	//Por favor, aguarde...
	define("LANG_LABEL_FORM_WAIT", "Por favor espera ...");
	//Título da Imagem
	...
	define("LANG_LABEL_TUTORIAL_TOUR-TITLE", "Este es el título que identifica a su artículo en el sitio. Sea breve, pero eficaz.");
	...
	define("LANG_LABEL_TUTORIAL_TOUR-TEMPLATE", "Elegir entre diferentes tipos de listados que ofrecen diversos campos y diseños específicos para listados común, o crear un nuevo tipo de listado que se adapte a sus necesidades.");
	...
	define("LANG_LABEL_TUTORIAL_TOUR-OWNER", "Esta es la cuenta que posee el elemento. Usted puede cambiar a otra cuenta o deje su artículo con ningún propietario.");
	...
	define("LANG_LABEL_TUTORIAL_TOUR-STATUS", "Artículos activadas estarán disponibles en la página de resultados. Artículos pendientes sólo se han añadido al sitio y están en espera de aprobación. Artículos caducados han ido más allá de su fecha de renovación sin pago y, por último, usted puede hacer temporalmente un elementos suspendidos en su elección.");
	//You can manually set the Renewal Date for an items to set when the next payment is due.
	define("LANG_LABEL_TUTORIAL_TOUR-EXPIRATION", "Puede configurar manualmente la fecha de renovación de un artículo para establecer cuando el próximo pago.");
	...
	define("LANG_LABEL_TUTORIAL_TOUR-CLAIM", "Marque esta casilla para desactivar la función de demanda y no permiten a los propietarios para reclamar su listado. Déjelo en blanco si desea permitir a los usuarios afirman su listado.");
	...
	define("LANG_LABEL_TUTORIAL_TOUR-KEYWORDS", "Puede etiquetar palabras clave específicas en este campo. Palabras clave ayudarán a los usuarios a encontrar su artículo en la búsqueda en el sitio.");
	...
	define("LANG_LABEL_TUTORIAL_TOUR-CONTACT", "En esta sección usted puede agregar toda la información de ubicación y contacto de su artículo. La más completa, más fácil es para que los clientes se pongan en contacto con usted.");
	//Use this field to add a location reference for your listing. For example, two blocks from the mall.
	define("LANG_LABEL_TUTORIAL_TOUR-REFERENCE", "Utilice este campo para agregar una referencia para su ubicación. Por ejemplo, a dos cuadras del centro comercial.");
	//Does your business have a Facebook page? Type it here to show the Facebook wall widget on the listing's detail page.
	define("LANG_LABEL_TUTORIAL_TOUR-FACEBOOK", "¿Su negocio tiene una página de Facebook? Escriba aquí para mostrar el widget muro de Facebook en la página de detalles del listado.");
	...
	define("LANG_LABEL_TUTORIAL_TOUR-FEATURES", "Utilice este campo para poner de relieve algunas de las características de su negocio o añadir cualquier información adicional útil, lo que lo hace especial.");
	//Type the hours of work for your business here.
	define("LANG_LABEL_TUTORIAL_TOUR-HOURS", "Escriba las horas de trabajo para su negocio aquí.");
	//If applicable, use this field to describe the average price for your products or services.
	define("LANG_LABEL_TUTORIAL_TOUR-PRICE", "Si procede, utilice este campo para describir el precio medio de sus productos o servicios.");
	//Have a discount or promotional code? Type it here. The item's next payment will be affected.
	define("LANG_LABEL_TUTORIAL_TOUR-DISCOUNT", "Tener un descuento o código promocional? Escriba aquí. Próximo pago del artículo será afectada.");
	//Use this box to drop and add images. You can click on a image to adjust the cropping and edit the title and description.
	define("LANG_LABEL_TUTORIAL_TOUR-IMAGES", "Utilice esta casilla para soltar y añadir imágenes. Puede hacer clic en una imagen para ajustar el recorte y editar el título y la descripción.");
	//Copy and paste your video URL here. Add a brief description to say what your video is about.
	define("LANG_LABEL_TUTORIAL_TOUR-VIDEO", "Copie y pegue el URL del video aquí. Añadir una descripción breve de decir lo que su video es sobre.");
	//Use this field to attach an additional file. Use it for a Menu, Product Brochure, or whatever you'd like.
	define("LANG_LABEL_TUTORIAL_TOUR-FILE", "Utilice este campo para adjuntar un archivo adicional. Utilícelo para un menú, el folleto del producto, o lo que usted quisiera.");
	...
	define("LANG_LABEL_TUTORIAL_TOUR-ADDITIONAL", "Utilice esta sección para configurar alguna información más adicional para su negocio.");
	//Deals should be assigned to a listing in order to be shown on the results. Use this box to select a listing
	define("LANG_LABEL_TUTORIAL_TOUR-LISTING", "Ofertas debe ser asignado a un listado para ser mostrado en los resultados. Utilice este cuadro para seleccionar un listado");
	...
	define("LANG_LABEL_TUTORIAL_TOUR-CONDITIONS", "Este campo está pre-llenado con un texto predeterminado que se describen los términos de uso y condiciones para canjear un oferta. Usted puede cambiarlo a lo que usted necesita.");
	...
	define("LANG_LABEL_TUTORIAL_TOUR-DATE2", "Utilice esta sección para configurar cuando el oferta estará disponible. Después de la fecha de finalización éxitos, ya no se muestra en ningún resultado.");
	...
	define("LANG_LABEL_TUTORIAL_TOUR-DATE", "Utilice esta sección para configurar cuando su evento está llevando a cabo. También puede utilizar la casilla de verificación periódica para guardar un evento que se repite de forma regular.");
	...
	define("LANG_LABEL_TUTORIAL_TOUR-IMPRESSIONS", "Las impresiones se refieren al número de veces que el banner se muestra en las páginas del frontend.");
	//Use this field to identify the article's author.
	define("LANG_LABEL_TUTORIAL_TOUR-AUTHOR", "Utilice este campo para identificar el autor del artículo.");
	//If the article's author has a website, you can type it in here.
	define("LANG_LABEL_TUTORIAL_TOUR-AUTHORURL", "Si el autor del artículo tiene un sitio web, puede escribirla aquí.");
	...
	define("LANG_ATTACHDEAL_UNAVAILABLE", "No hay ofertas disponibles para la asociación con esta propiedad. Con el fin de estar vinculado a este perfil, el acuerdo no debe asociarse con otro anuncio y debe pertenecer a la misma cuenta.");
	...
	define("LANG_ATTACHLISTING_UNAVAILABLE", "No hay resultados disponibles para la asociación con este acuerdo. Con el fin de estar vinculado a este acuerdo, la lista no debe asociarse con otra cosa y debe pertenecer a la misma cuenta.");
	//Leave it blank to unlink the deal.
	define("LANG_ATTACHDEAL_EMPTY", "Déjelo en blanco para desvincular el acuerdo.");
