<?
    ...
    # ----------------------------------------------------------------------------------------------------
    # * FILE: /includes/tables/table_promotion_reports.php
    # ----------------------------------------------------------------------------------------------------
?>
...
?>
        <tr>
            <th  class="table-report" colspan="3">
                <?
                    if(string_strpos($_SERVER['REQUEST_URI'], "/".SITEMGR_ALIAS."") !== false) {
                        if ($promotion->getNumber("account_id")) {
                            ...
                            $username = system_showTruncatedText(system_showAccountUserName($account->getString("username")), 35);
                ...
                ?>
                <?=system_showText(LANG_LABEL_NAME)?>: <span title="<?=$promotion->getString('name', true);?>"><?=$promotion->getString('name', true, 35);?></span>
                <span><?=$owner?></span>
            </th>
        </tr>
...
?>
    <script type="text/javascript">
        function changeChart(idx, value1, value2) {
            ...
            document.getElementById("reportChart").innerHTML = "<img src='http://chart.googleapis.com/chart?chs=630x200&amp;chf=bg,s,ffffff|c,s,ffffff&amp;chxt=x,y&amp;chxl=1:||0:|||&amp;cht=bhg&amp;chd=t:"+value1+"|"+value2+"&amp;chdl="+label1+"|"+label2+"&amp;chco=ce9c52,d3cd83&amp;chbh=25' alt='Report Chart'/>";
        }
