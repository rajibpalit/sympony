...
?>
    <script type="text/javascript">
        function changeChart(idx, value1, value2, value3, value4, value5, value6, value7, value8) {
            ...
            document.getElementById("reportChart").innerHTML = "<img src='http://chart.googleapis.com/chart?chs=630x200&amp;chf=bg,s,ffffff|c,s,ffffff&amp;chxt=x,y&amp;chxl=1:||0:|||&amp;cht=bhg&amp;chd=t:"+value1+"|"+value2+"|"+value3+"|"+value4+<?=$auxScriptValue?>"&amp;chdl="+label1+"|"+label2+"|"+label3+"|"+label4+<?=$auxScriptLabel?>"&amp;chco=ce9c52,d3cd83,fa5353,527bce<?=$auxScriptColor?>&amp;chbh=<?=(TWILIO_APP_ENABLED == "on" ? "15" : "25")?>' alt='Report Chart'/>";
        }
