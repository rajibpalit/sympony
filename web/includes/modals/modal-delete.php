<?
    ...
    */
    ...
    if (string_strpos($_SERVER["PHP_SELF"], "/account/sponsor") !== false || string_strpos($_SERVER["PHP_SELF"], "/account/visitor") !== false) {
    ...
    } elseif (string_strpos($_SERVER["PHP_SELF"], "/mobile/adverts/") !== false) {
        $modalTitle = system_showText(LANG_SITEMGR_DELETE)." ".system_showText(LANG_SITEMGR_MOBILE_ADVERT_SING);
        ...
        $modalMessage = system_showText(LANG_SITEMGR_MSGAREYOUSURE);
    } elseif (string_strpos($_SERVER["PHP_SELF"], "/pages/") !== false) {
        $modalTitle = system_showText(LANG_SITEMGR_DELETE)." ".system_showText(LANG_SITEMGR_CUSTOMPAGE);
        $modalMessage = system_showText(LANG_SITEMGR_MSGAREYOUSURE);
        ...
        if ($item_type == "blog") {
            ...
            $modalMessage = system_showText(LANG_MESSAGE_MSGAREYOUSURE);
        } else {
