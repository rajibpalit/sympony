<?
	...
	************************************************/
	if (is_numeric($search_category_id) && $manageModule != "promotion" && $manageModule != "banner") {
	...
	************************************************/
	if ($search_discount && $manageModule != "promotion" && $manageModule != "blog") {
	...
	************************************************/
    if ($search_title) {
        if ($manageModule == "banner") {
            ...
            $search_for_keyword_fields[] = ($manageModule == "listing" ? "Listing_Summary" : ($manageModule == "blog" ? "Post" : ucfirst($manageModule))).".fulltextsearch_keyword";
