<?php
    ...
    if ( $_SERVER['REQUEST_METHOD'] == "POST" && !DEMO_LIVE_MODE )
    {
        ...
        if (trim($setting_instagram_link) != "")
        {
            ...
            {
                $setting_instagram_link = "http://".$setting_instagram_link;
            }
        }
        ...
        if (trim($setting_googleplus_link) != "")
        {
            ...
            {
                $setting_googleplus_link = "http://".$setting_googleplus_link;
            }
        }
        ...
        if (trim($setting_pinterest_link) != "")
        {
            ...
            {
                $setting_pinterest_link = "http://".$setting_pinterest_link;
            }
        }
