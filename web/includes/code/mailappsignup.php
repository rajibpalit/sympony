		...
		if (validate_form("mailapp_signup", $_POST, $message_mailapp)) {
            ...
            //Create or update list
                ...
                if ($edir_list_id) {
                    ...
                    if (!setting_set("arcamailer_enable_list", $enable_list)) {
                        if (!setting_new("arcamailer_enable_list", $enable_list)) {
                            $error = true;
                        }
                    }

                    if (!setting_set("arcamailer_list_label", $edir_list_label)) {
                        if (!setting_new("arcamailer_list_label", $edir_list_label)) {
                            $error = true;
                        }
                    }
