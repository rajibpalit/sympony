<?
                ...
                if ($_FILES) {
                    ...
                    if (count($image_errors) == 0) {
                        if ($_FILES["file_background_image"]["error"] == 0) {
                            ...
                            $image_upload = image_uploadForSitemgr(EDIRECTORY_ROOT.BKIMAGE_PATH."/".BKIMAGE_NAME.".".BKIMAGE_EXT, $_FILES["file_background_image"]["tmp_name"]);
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST" && !DEMO_LIVE_MODE && $submitAction == "changetheme") {
        ...
        if ($action == "submit") {
            ...
            colorscheme_generateDynamicCSS();
    ...
    $table_colors_1 = array(0 => "NavbarLink", 1 => "FooterLink");
    $table_colors_2 = array(0 => "Navbar");
    $table_colors_3 = array(0 => "1", 1 => "2");