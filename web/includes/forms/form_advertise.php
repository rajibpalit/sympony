            ...
            <div class="order-head">
                <h2 class="theme-title">
                    ...
                    <? if ($payment_tax_status == "on") { ?>
                        <small id="divTax" class="isHidden" <?=($advertiseItem == "banner" ? "style=\"display: none;\"" : "")?>>
                            <small class="text-success" id="taxInfo"></small>
                        </small>
                    <? } ?>
                </h2>
            </div>
                ...
                <div class="row">
                    <div class="col-sm-4 col-sm-offset-4">
                        ...
                        <div id="check_out_payment" class="<?=$checkoutpayment_class?>">
                            ...
                            <p class="text-center">
                                <br>
                                <a href="<?=NON_SECURE_URL?>/<?=ALIAS_ADVERTISE_URL_DIVISOR?>/"><?=system_showText(LANG_ADVERTISE_BACK);?></a>
                                <em><?=$msgLogged;?></em>
                            </p>
                        </div>
                        <? } ?>
