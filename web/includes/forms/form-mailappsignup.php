            ...
            <form name="mailapp" method="post" action="<?=system_getFormAction($_SERVER["PHP_SELF"])?>">
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-6">
                            <label for="idlistLabel"><?=system_showText(LANG_SITEMGR_MAILAPP_NEWSLETTER_LABEL);?></label>
                            <input class="form-control" type="text" id="idlistLabel" name="edir_list_label" <?=(!$edir_customer_id ? "disabled=\"disabled\"" : "")?> maxlength="50" value="<?=($edir_list_label ? $edir_list_label : LANG_SITEMGR_MAILAPP_NEWSLETTER_LABEL_TIP);?>" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="checkbox">
                            <label>
                                ...
                                <?=system_showText(LANG_SITEMGR_MAILAPP_ACTIVATENEWSLETTER);?>
                            </label>
                        </div>
                    </div>
