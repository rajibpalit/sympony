                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <label class="radio-inline" for="date_format-0">
                            <input type="radio" name="date_format" id="date_format-0" value="m/d/Y" <?=(DEFAULT_DATE_FORMAT == "m/d/Y" ? "checked=\"checked\"" : "")?>>
                            mm-dd-yyyy
                        </label>
                        <label class="radio-inline" for="date_format-1">
                            <input type="radio" name="date_format" id="date_format-1" value="d/m/Y" <?=(DEFAULT_DATE_FORMAT == "d/m/Y" ? "checked=\"checked\"" : "")?>>
                            dd-mm-yyyy
                        </label>
                    </div>
                </div>
