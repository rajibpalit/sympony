...
?>
    ...
    <div class="col-md-9">
        ...
        <div class="panel panel-default ">
            <div class="panel-heading">Elasticsearch index</div>
            <div class="panel-body">
                Rebuild Elasticsearch index
                <p class="help-block"><small>This may solve problems related to missing items in results pages. <b>This operation will take some minutes to finish, please be patient.</b></small></p>
            </div>
            <div class="panel-footer">
                <a class="btn btn-primary btn-success" href="?action=esindex">Rebuild Elasticsearch Index</a>
            </div>
        </div>

        <div class="panel panel-default ">
            <div class="panel-heading">Elasticsearch Location index</div>
            <div class="panel-body">
                Rebuild location index
                <p class="help-block"><small>This may solve problems related to missing locations in results pages. <b>This operation will take some minutes to finish, please be patient.</b></small></p>
            </div>
            <div class="panel-footer">
                <a class="btn btn-primary btn-success" href="?action=eslocations">Rebuild Location Index</a>
            </div>
        </div>
