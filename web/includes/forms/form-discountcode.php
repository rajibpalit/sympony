...
?>
        ...
        <div class="panel panel-form">
            ...
            <div class="panel-body">
                ...
                <div class="form-group row">
                    <div class="col-sm-6">
                        <label for="expire_date"><?=system_showText(LANG_SITEMGR_EXPIRATIONDATE)?></label>
                    ...
                    <div class="col-sm-6">
                        <div class="col-sm-12 row">
                            <label><?=system_showText(LANG_RECURRING)?> </label>
                        </div>
    ...
    <div class="col-sm-5">
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <p class="help-block">
                    <b><?=system_showText(LANG_RECURRING)?></b>: <?=system_showText(LANG_SITEMGR_PROMOTIONALCODE_ALLOWREPEAT_TEXT)?>
                </p>
            </div>
        </div>
    </div>