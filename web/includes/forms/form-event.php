...
?>
    ...
    <div class="col-md-7">
        ...
        <div class="form-group" id="tour-title">
            ...
            <input type="text" class="form-control input-lg" name="title" id="name" value="<?=$title?>" maxlength="100" <?=(!$id) ? " onblur=\"easyFriendlyUrl(this.value, 'friendly_url', '".FRIENDLYURL_VALIDCHARS."', '".FRIENDLYURL_SEPARATOR."');\" " : ""?> placeholder="<?=system_showText(LANG_HOLDER_EVENTTITLE)?>">
        ...
        <div class="panel panel-form">
            ...
            <div class="panel-body">
                ...
                <div class="form-group" id="tour-summary">
                    ...
                    <textarea id="summary" name="description" class="textarea-counter form-control <?=($highlight == "description" && !$description ? "highlight" : "")?>" rows="2" data-chars="250" data-msg="<?=system_showText(LANG_MSG_CHARS_LEFT)?>" placeholder="<?=system_showText(LANG_HOLDER_EVENTSUMMARY);?>"><?=$description;?></textarea>
                </div>
                <? } ?>
        ...
        <? if ($levelObjAux->getdetail($level) == "y") { ?>
            ...
            <div class="panel panel-form-media">
                <div class="panel-heading">
                    ...
                    <i class="icon-ion-ios7-trash-outline" onclick="sendCoverImage('event', '<?=$_SERVER["PHP_SELF"]?>', <?=($account_id ? $account_id : 0 )?>, 'deleteCover');" ></i>
                </span>
                    <div class="pull-right">
                        <input type="file" name="cover-image" class="file-noinput" onchange="sendCoverImage('event', '<?=$_SERVER["PHP_SELF"]?>', <?=($account_id ? $account_id : 0 )?>, 'uploadCover');">
                    </div>
                </div>
                <div class="panel-body">
