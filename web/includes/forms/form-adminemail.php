                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">                        
                        <div class="form-horizontal">
                            ...
                            <div class="form-group row">
                                <label class="control-label col-sm-5"> <?=ucfirst(system_showText(LANG_LABEL_LEADS))?></label>
                                <div class="col-sm-7">
                                    <input type="text" class="form-control" name="sitemgr_lead_email" value="<?=$sitemgr_lead_email?>" placeholder="<?=system_showText(LANG_SITEMGR_LABEL_EMAIL)?>">
                                </div>                       
                            </div>
