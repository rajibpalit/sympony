...
?>
    ...
    <div class="col-md-7">
        ...
        <div class="form-group" id="tour-title">
            ...
            <input type="text" class="form-control input-lg" name="title" id="name" value="<?=$title?>" maxlength="100" <?=(!$id) ? " onblur=\"easyFriendlyUrl(this.value, 'friendly_url', '".FRIENDLYURL_VALIDCHARS."', '".FRIENDLYURL_SEPARATOR."');\" " : ""?> placeholder="<?=system_showText(LANG_HOLDER_ARTICLETITLE)?>">
            ...
            <div class="panel-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4" id="tour-publication">
                        ...
                        <input type="text" class="form-control date-input" name="publication" id="publication" placeholder="<?=format_printDateStandard()?>" value="<?=$publication_date?>">
                    </div>
                ...
                <div class="form-group" id="tour-abstract">
                    ...
                    <textarea id="abstract" name="abstract" class="textarea-counter form-control" rows="2" data-chars="250" data-msg="<?=system_showText(LANG_MSG_CHARS_LEFT)?>" placeholder="<?=system_showText(LANG_HOLDER_ARTICLESUMMARY);?>"><?=$abstract;?></textarea>
                </div>
        ...
        <div class="panel panel-form-media">
            <div class="panel-heading">
                ...
                <span class="btn btn-sm btn-danger delete pull-right <?=(!$cover_id ? "hidden" : "")?>" id="buttonReset">
                    <i class="icon-ion-ios7-trash-outline" onclick="sendCoverImage('article', '<?=$_SERVER["PHP_SELF"]?>', <?=($account_id ? $account_id : 0 )?>, 'deleteCover');" ></i>
                </span>
                <div class="pull-right">
                    <input type="file" name="cover-image" class="file-noinput" onchange="sendCoverImage('article', '<?=$_SERVER["PHP_SELF"]?>', <?=($account_id ? $account_id : 0 )?>, 'uploadCover');">
                </div>
            </div>
            <div class="panel-body">
