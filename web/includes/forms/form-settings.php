        ...
        <div class="col-md-10">
            <div class="panel panel-default">
                ...
                <div class="panel-footer">
                    ...
                    <a href="<?=DEFAULT_URL."/".SITEMGR_ALIAS."/design/pages-custom/content.php?id=74"?>" target="_blank" class="btn btn-default pull-left"><?=system_showText(LANG_SITEMGR_SETTING_MAINTENANCE_TIP2);?></a>
                </div>
            </div>
