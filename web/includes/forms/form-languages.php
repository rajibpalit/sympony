...
?>
    <!--<div class="col-xs-12">
        <p class="text-right">
            <a href="<?=$url_base?>/edit.php" class="btn btn-sm btn-info"><?=system_showText(LANG_SITEMGR_LANGUAGES_EDIT)?></a>
            <a href="<?=$url_base?>/add.php" class="btn btn-sm btn-info"><?=system_showText(LANG_SITEMGR_LANGUAGES_ADD)?></a>
        </p>
    </div>-->
    <div class="col-sm-6">
