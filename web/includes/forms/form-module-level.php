...
?>
            ...
            <div class="row level-choice">
                ...
                <? foreach ($levelvalues as $levelvalue) {
                    ...
                    if ($levelObj->getPrice($levelvalue) > 0) {
                        $levelPrice = CURRENCY_SYMBOL.$levelObj->getPrice($levelvalue);
                        $levelPrice .= " / ";
                        if (payment_getRenewalCycle($addingModule) > 1) {
                            $levelPrice .= payment_getRenewalCycle($addingModule)." ";
                            $levelPrice .= payment_getRenewalUnitName($addingModule)."s";
                        } else {
                            $levelPrice .= payment_getRenewalUnitName($addingModule);
                        }
                    } else {
                        $levelPrice = system_showText(LANG_LABEL_FREE);
                    }
                    ?>
    ...
    <section class="row type-choice hidden">
        ...
        <div class="form-thumbnails">
            ...
            <p><?=str_replace("[a]", "<a href=\"".DEFAULT_URL."/".SITEMGR_ALIAS."/design/listing-types/\" target=\"_blank\">",str_replace("[/a]", "</a>", system_showText(LANG_SELECT_LISTINGTEMPLATE_TIP)));?></p>
            <br>
            <div class="row">
