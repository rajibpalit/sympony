...
////////////////////////////////////////////////////////////////////////////////////////////////////
$messageLog = "Update expired notifications - LINE: " . __LINE__;
log_addCronRecord($link, "daily_maintenance", $messageLog, true, $cron_log_id);
$sql = "SELECT id FROM AppNotification WHERE expiration_date < DATE_FORMAT(NOW(), '%Y-%m-%d')";
$result = mysql_query($sql, $linkDomain);
while ($row = mysql_fetch_assoc($result)) {
    $notifObj = new AppNotification($row["id"]);
    $notifObj->setString("status", "E");
    $notifObj->Save();
}
////////////////////////////////////////////////////////////////////////////////////////////////////

////////////////////////////////////////////////////////////////////////////////////////////////////
$messageLog = "Update expired adverts - LINE: " . __LINE__;
log_addCronRecord($link, "daily_maintenance", $messageLog, true, $cron_log_id);
$sql = "SELECT id FROM AppAdvert WHERE expiration_date < DATE_FORMAT(NOW(), '%Y-%m-%d')";
$result = mysql_query($sql, $linkDomain);
while ($row = mysql_fetch_assoc($result)) {
    $notifObj = new AppAdvert($row["id"]);
    $notifObj->setString("status", "E");
    $notifObj->Save();
}
////////////////////////////////////////////////////////////////////////////////////////////////////
...
$sql = "SELECT COUNT(id) AS total FROM Listing WHERE entered >= '" . date("Y-m-d",
...
$sql = "SELECT COUNT(id) AS total FROM Event WHERE entered >= '" . date("Y-m-d",
        mktime(0, 0, 0, date("m") - 1, date("d"), date("Y"))) . "'";
$result = mysql_query($sql, $linkDomain);
if ($result) {
    if ($row = mysql_fetch_assoc($result)) {
...
$sql = "SELECT COUNT(id) AS total FROM Banner WHERE entered >= '" . date("Y-m-d",
        mktime(0, 0, 0, date("m") - 1, date("d"), date("Y"))) . "'";
$result = mysql_query($sql, $linkDomain);
if ($result) {
    if ($row = mysql_fetch_assoc($result)) {
...
$sql = "SELECT COUNT(id) AS total FROM Classified WHERE entered >= '" . date("Y-m-d",
        mktime(0, 0, 0, date("m") - 1, date("d"), date("Y"))) . "'";
$result = mysql_query($sql, $linkDomain);
if ($result) {
    if ($row = mysql_fetch_assoc($result)) {
...
$sql = "SELECT COUNT(id) AS total FROM Article WHERE entered >= '" . date("Y-m-d",
        mktime(0, 0, 0, date("m") - 1, date("d"), date("Y"))) . "'";
$result = mysql_query($sql, $linkDomain);
if ($result) {
    if ($row = mysql_fetch_assoc($result)) {
