...
?>
    ...
    <section class="top-search">
        ...
        <div class="well well-translucid">
            <div class="container">
                <br>
                <h1><?=system_showText(LANG_LABEL_LOGIN_SPONSORAREA);?></h1>
                <br>
            </div>
        </div>
            ...
            <div class="col-md-6 col-sm-offset-3">
                <div class="panel panel-theme">
                    ...
                    <div class="panel-body">
                        ...
                        <p class="text-center">
                            <a href="<?=NON_SECURE_URL?>/<?=ALIAS_ADVERTISE_URL_DIVISOR?>/" class="btn btn-default btn-block"><?=system_showText(LANG_DOYOUWANT_ADVERTISEWITHUS)?></a>
                            <br><br>
