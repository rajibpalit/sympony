<?
	...
	include_once(CLASSES_DIR."/simplepay/class_SimplePay.php");
	...
	include_once(CLASSES_DIR."/class_LocationFeatured.php");
	...
	include_once(CLASSES_DIR."/class_Twitter.php");
	include_once(CLASSES_DIR."/class_json.php");
	include_once(CLASSES_DIR."/class_Profile.php");
	include_once(CLASSES_DIR."/facebook/facebook.php");
	include_once(CLASSES_DIR."/twitter/EpiCurl.php");
	include_once(CLASSES_DIR."/twitter/EpiOAuth.php");
	include_once(CLASSES_DIR."/twitter/EpiTwitter.php");
	include_once(CLASSES_DIR."/class_Quicklist.php");
	include_once(CLASSES_DIR."/class_Listing_Category.php");
	include_once(CLASSES_DIR."/class_ListingSummary.php");
	...
	include_once(CLASSES_DIR."/class_CheckIn.php");
	...
	include_once(CLASSES_DIR."/class_AppNotification.php");
	include_once(CLASSES_DIR."/class_AppAdvert.php");
	include_once(CLASSES_DIR."/class_MailAppList.php");
	include_once(CLASSES_DIR."/class_LocationCounter.php");
    ...
    include_once(FUNCTIONS_DIR."/wordpress_funct.php");
	...
	include_once(FUNCTIONS_DIR."/api_funct.php");
	if (SUGARCRM_FEATURE == "on"){
		include_once(FUNCTIONS_DIR."/sugar_funct.php");
	}
