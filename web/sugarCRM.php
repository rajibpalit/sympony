    ...
    if ($_GET["url_full"]) {
        ...
        <html lang="<?=system_getHeaderLang();?>">
            ...
            <head>
                ...
                <?=system_getFavicon();?>
                <link rel="stylesheet" href="<?=DEFAULT_URL?>/assets/css/sugarcrm.css" type="text/css" />
            ...
            <body class="sugarCRMScreen">
                ...
                <div>
                    <div class="sugarLogo">
                        <img src="<?=DEFAULT_URL?>/assets/images/structure/bg_edirectory_sugarcmr_logo.png" alt=""/>
                        <? if (!$errorMessage) {?>
                    ...
                    <? if (!$errorMessage) {?>
                        ...
                        <form class="sugarCRMForm" method="post" action="<?=(SSL_ENABLED == "on" && FORCE_MEMBERS_SSL == "on" && FORCE_ORDER_SSL == "on" ? SECURE_URL : NON_SECURE_URL)?>/order_listing.php">
