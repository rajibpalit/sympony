<?
    ...
    class NewImageUploader
    {
         ...
         */
        public function buildform( $divId = "tour-images", $plural = true )
        {
        ...
        public function registerJavaScript()
        {
            ...
            {
                object = $(item);
                var image_id  = object.data("image_id");
                var thumb_id  = object.data("thumb_id");
        ...
        public static function treatPost( $url_base, $moduleTable )
        {
            if( $_POST['cropSystem'] )
            {
                ...
                if ( $newDimensions["width"] > 0 && $newDimensions["height"] > 0 && $originalImage && $responseArray["errors"] === null )
                {
                    ...
                    /* retrieve the right dimensons for each module */
                    switch( $moduleTable )
                    {
                        case "Article" :
