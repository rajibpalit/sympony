<?
	...
	class EventLevel {
        ...
        function updateValues($name, $active, $detail = "", $images = "", $levelValue, $type = "names", $popular = ""){
            ...
            if ($type == "names") {
                $sql = "UPDATE EventLevel SET name = '".$name."', active = '".$active."', popular = '".$popular."' WHERE value = ".$levelValue." AND theme = '".(EDIR_THEME ? EDIR_THEME : "default")."'";
            } elseif ($type == "fields") {
                $sql = "UPDATE EventLevel SET detail = '".$detail."', images = '".$images."' WHERE value = ".$levelValue." AND theme = '".(EDIR_THEME ? EDIR_THEME : "default")."'";
            }
        ...
        function updateFeatured($newValue, $level){
            ...
            $sql = "UPDATE EventLevel SET featured = '{$newValue}' WHERE value = {$level} AND theme = '".(EDIR_THEME ? EDIR_THEME : "default")."'";
            $dbObj->query($sql);
        }
