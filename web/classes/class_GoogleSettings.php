<?
    ...
    class GoogleSettings
    {
        ...
        function Save()
        {
            ...
            foreach( $this->settingDictionary as $key => $value )
            {
                ...
                $sql = "INSERT INTO ".self::$table." (name, value)".
                       "VALUES( '{$key}', '{$filteredValue}')".
                       "ON DUPLICATE KEY UPDATE value = '{$filteredValue}'";
        ...
        function getTypeCode()
        {
            ...
            switch ( $this->adType )
            {
                case 1: $adTypes = "text";       break;
                case 2: $adTypes = "image";      break;
                case 3: $adTypes = "text_image"; break;
            }
