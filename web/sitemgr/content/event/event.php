<?
    ...
    */
    ...
    # ----------------------------------------------------------------------------------------------------
	# * FILE: /ed-admin/content/event/event.php
	# ----------------------------------------------------------------------------------------------------
...
?> 
    ...
    <main class="wrapper togglesidebar container-fluid">
        ...
        if ($id) {
            $arrayCompletion = system_gamefyItems("event", $event);
        ?>
        ...
        <form role="form" name="event" id="event" action="<?=system_getFormAction($_SERVER["PHP_SELF"])?>" method="post" enctype="multipart/form-data">
            ...
            <section class="row heading">
	           	...
	           	<div class="container">
                    ...
                    <div class="col-sm-8">
                         <? if ($id) { ?>
                        <h1><?=string_ucwords(system_showText(LANG_SITEMGR_EDIT))." ".system_showText(LANG_SITEMGR_EVENT_SING)?> <i><?=$event->getString("title")?></i></h1>
                        <? } else { ?>
                        <h1><?=string_ucwords(system_showText(LANG_SITEMGR_ADD))." ".system_showText(LANG_SITEMGR_EVENT_SING)?></h1>
                        <? } ?>
                    </div>
			...
			<section class="row tab-options">
                ...
                <div class="container">
                    ...
                    <? include(SM_EDIRECTORY_ROOT."/layout/nav-tabs-content-event.php"); ?>

                    <div class="pull-right top-actions">
                        <a href="<?=DEFAULT_URL."/".SITEMGR_ALIAS."/content/".EVENT_FEATURE_FOLDER."/"?>" class="btn btn-default btn-xs"><?=system_showText(LANG_CANCEL)?></a>
