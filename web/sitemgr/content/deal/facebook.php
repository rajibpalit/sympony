<?
    ...
    */
    ...
    # ----------------------------------------------------------------------------------------------------
	# * FILE: /ed-admin/content/deal/facebook.php
	# ----------------------------------------------------------------------------------------------------
	...
	if (!$commenting_fb){
		header("Location: ".DEFAULT_URL."/".SITEMGR_ALIAS."content//".PROMOTION_FEATURE_FOLDER."/index.php?message=".$message."&screen=$screen&letter=$letter".(($url_search_params) ? "&$url_search_params" : "")."");
		exit;
	}
    ...
    $detailLink = PROMOTION_DEFAULT_URL."/".$itemObj->getString("friendly_url").".html";
    ...
    <main class="wrapper togglesidebar container-fluid">
        ...
        <form role="form" name="facebook_form" id="facebook_form" action="<?=system_getFormAction($_SERVER["PHP_SELF"])?>" method="post">
            ...
            <section class="row heading">
	           	...
	           	<div class="container">
                    <div class="col-sm-8">
    	           		<h1><?=string_ucwords(system_showText(LANG_LABEL_FACEBOOK_COMMENTS))?> <i><?=$itemObj->getString("name")?></i></h1>
                    </div>
				</div>
