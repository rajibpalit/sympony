...
?> 
    ...
    <main class="wrapper togglesidebar container-fluid">
        ...
        <form role="form" name="listing" id="listing" action="<?=system_getFormAction($_SERVER["PHP_SELF"])?>" method="post" enctype="multipart/form-data">
            ...
            <section class="row heading">                
	           	...
	           	<div class="container">
                    ...
                    <div class="col-sm-4 text-right  hidden-xs hidden-sm">
                        <br><br>
                        <a href="javascript:void(0);" data-tour class="text-info tutorial-text"><?=system_showText(LANG_LABEL_TUTORIAL);?> <i class="icon-help8"></i></a>
                    </div>
