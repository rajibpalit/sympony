<?
    ...
    */
    ...
    # ----------------------------------------------------------------------------------------------------
	# * FILE: /ed-admin/content/listing/facebook.php
	# ----------------------------------------------------------------------------------------------------
	...
	if ($id) {
		...
		$listingHasDetail = $levelObj->getDetail($listing->getNumber("level"));
    ...
    <main class="wrapper togglesidebar container-fluid">
        ...
        <form role="form" name="facebook_form" id="facebook_form" action="<?=system_getFormAction($_SERVER["PHP_SELF"])?>" method="post">
            ...
            <section class="row heading">
	           	...
	           	<div class="container">
                    <div class="col-sm-8">
    	           		<h1><?=string_ucwords(system_showText(LANG_LABEL_FACEBOOK_COMMENTS))?> <i><?=$listing->getString("title")?></i></h1>
                    </div>
				</div>
