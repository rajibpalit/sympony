        ...
        <section class="row heading">
            <div class="container">
                ...
                <p><?=system_showText(LANG_SITEMGR_DOWNLOAD_TEMPLATE);?> <a href="importsample.php?type=<?=$module?>"><?=system_showText(LANG_SITEMGR_DOWNLOAD_TEMPLATE2);?></a>
                    <span class="pull-right"><a href="<?=DEFAULT_URL;?>/<?=SITEMGR_ALIAS?>/faq.php?keyword=<?=urlencode("import");?>" target="_blank" class="text-info tutorial-text"><?=system_showText(LANG_SITEMGR_IMPORT_HOMETIP1_3)?> <i class="icon-help8"> </i></a></span>
                </p>
            </div>
        </section>
                ...
                <div class="col-sm-12">
                    ...
                    <div class="panel panel-default">
                            ...
                            <div id="selectFile2" style="display: none;">
                                <div class="panel-body">
                                    <div class="col-sm-6">
                                        <input type="text" id="file_name" name="file_name" class="form-control" value="<?=!$messageErrorUpload? $file_name: "";?>" readonly>
                                    </div>
                                </div>
                            </div>
                            </form>
