<?
    ...
    */
    ...
    # ----------------------------------------------------------------------------------------------------
	# * FILE: /ed-admin/content/blog/index.php
	# ----------------------------------------------------------------------------------------------------
    ...
    $manageOrder = system_getManageOrderBy($_POST["order_by"] ? $_POST["order_by"] : $_GET["order_by"], "Blog", BLOG_SCALABILITY_OPTIMIZATION, $fields);

	extract($_GET);
	extract($_POST);
    
    $manageModule = "blog";
    $manageModuleFolder = BLOG_FEATURE_FOLDER;
	...
	// Page Browsing /////////////////////////////////////////
	unset($pageObj);
	$pageObj = new pageBrowsing("Post", $screen, RESULTS_PER_PAGE, ($_GET["newest"] ? "id DESC" : $manageOrder), "title", $letter, $where, $fields);
	$posts = $pageObj->retrievePage();
	$paging_url = DEFAULT_URL."/".SITEMGR_ALIAS."/content/".BLOG_FEATURE_FOLDER."/index.php";
...
<?php
	...
	# FOOTER
	# ----------------------------------------------------------------------------------------------------
    $modalSettingsPath = DEFAULT_URL."/".SITEMGR_ALIAS."/content/settings-module.php?manageModule=blog";
