<?
    ...
    */
    ...
    # ----------------------------------------------------------------------------------------------------
	# * FILE: /ed-admin/content/blog/seocenter.php
	# ----------------------------------------------------------------------------------------------------
	...
	# CODE
	# ----------------------------------------------------------------------------------------------------
	include(EDIRECTORY_ROOT."/includes/code/blog_seocenter.php");
    ...
    <main class="wrapper togglesidebar container-fluid">
        ...
        <form role="form" name="seocenter" action="<?=system_getFormAction($_SERVER["PHP_SELF"])?>" method="post">
            ...
            <section class="row heading">
	           	...
	           	<div class="container">
                    <div class="col-sm-8">
                        <h1><?=string_ucwords(system_showText(LANG_SITEMGR_EDIT))." ".system_showText(LANG_SITEMGR_BLOG_SING)?> <i><?=$post->getString("title")?></i></h1>
                    </div>
			...
			<section class="row tab-options">
                ...
                <div class="container">
                    <? include(SM_EDIRECTORY_ROOT."/layout/nav-tabs-content-blog.php"); ?>
