<?php
    ...
    */
    ...
    # ----------------------------------------------------------------------------------------------------
	# * FILE: /ed-admin/content/blog/categories/category.php
	# ----------------------------------------------------------------------------------------------------
	...
	if ($wp_enabled == "on" && !$_GET["id"] && !$_POST["id"]) {
		header("Location: ".DEFAULT_URL."/".SITEMGR_ALIAS."/content/".BLOG_FEATURE_FOLDER."/categories/index.php");
		exit;
	}
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="text-right top-actions">
                                <a href="<?=DEFAULT_URL."/".SITEMGR_ALIAS."/content/".BLOG_FEATURE_FOLDER."/categories/"?>" class="btn btn-default btn-xs"><?=system_showText(LANG_CANCEL)?></a>
