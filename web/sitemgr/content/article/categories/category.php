<?php
    ...
    */
    ...
    # ----------------------------------------------------------------------------------------------------
	# * FILE: /ed-admin/content/article/categories/category.php
	# ----------------------------------------------------------------------------------------------------
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="text-right top-actions">
                                <a href="<?=DEFAULT_URL."/".SITEMGR_ALIAS."/content/".ARTICLE_FEATURE_FOLDER."/categories/"?>" class="btn btn-default btn-xs"><?=system_showText(LANG_CANCEL)?></a>
