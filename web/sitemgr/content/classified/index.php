<?
    ...
    */
    ...
    # ----------------------------------------------------------------------------------------------------
	# * FILE: /ed-admin/content/classified/index.php
	# ----------------------------------------------------------------------------------------------------
    ...
    $manageModule = "classified";
    $manageModuleFolder = CLASSIFIED_FEATURE_FOLDER;
	...
	$paging_url = DEFAULT_URL."/".SITEMGR_ALIAS."/content/".CLASSIFIED_FEATURE_FOLDER."/index.php";
...
<?php
	...
	# FOOTER
	# ----------------------------------------------------------------------------------------------------
    $modalSettingsPath = DEFAULT_URL."/".SITEMGR_ALIAS."/content/settings-module.php?manageModule=classified";
