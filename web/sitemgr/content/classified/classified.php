...
?> 
    ...
    <main class="wrapper togglesidebar container-fluid">
        ...
        <form role="form" name="classified" id="classified" action="<?=system_getFormAction($_SERVER["PHP_SELF"])?>" method="post" enctype="multipart/form-data">
            ...
            <section class="row heading">
	           	...
	           	<div class="container">
                    ...
                    <div class="col-sm-8">
                         <? if ($id) { ?>
                        <h1><?=string_ucwords(system_showText(LANG_SITEMGR_EDIT))." ".system_showText(LANG_SITEMGR_CLASSIFIED_SING)?> <i><?=$classified->getString("title")?></i></h1>
                        <? } else { ?>
			...
			<section class="row tab-options">
                ...
                <div class="container">
                    <? include(SM_EDIRECTORY_ROOT."/layout/nav-tabs-content-classified.php"); ?>

                    <div class="pull-right top-actions">
                        <a href="<?=DEFAULT_URL."/".SITEMGR_ALIAS."/content/".CLASSIFIED_FEATURE_FOLDER."/"?>" class="btn btn-default btn-xs"><?=system_showText(LANG_CANCEL)?></a>
