            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-12 control-add">
                    <div class="control-bar">
                        <a class="btn btn-sm btn-primary" href="<?=DEFAULT_URL."/".SITEMGR_ALIAS."/account/sponsor/sponsor.php"?>"><i class="icon-cross8"></i> <?=system_showText(LANG_SITEMGR_ADD_SPONSOR);?></a>
                    </div>
                </div>
