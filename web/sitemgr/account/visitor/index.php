            ...
            <div class="content-control">
                <div class="row">
                    ...
                    <div class="col-md-5 col-sm-4 col-xs-6 control-responsive">
                        <a class="btn btn-primary btn-responsive" title="<?=system_showText(LANG_SITEMGR_ADD_VISITOR);?>" href="<?=DEFAULT_URL."/".SITEMGR_ALIAS."/account/visitor/visitor.php"?>"><i class="icon-cross8"></i></a>
                    </div>

                    <div class="col-md-3 col-sm-12 control-add">
                        <div class="control-bar">
                            <a class="btn btn-sm btn-primary" href="<?=DEFAULT_URL."/".SITEMGR_ALIAS."/account/visitor/visitor.php"?>"><i class="icon-cross8"></i> <?=system_showText(LANG_SITEMGR_ADD_VISITOR);?></a>
                        </div>
                    </div>
