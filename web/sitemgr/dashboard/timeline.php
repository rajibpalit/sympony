        ...
        <div class="timeline-control">
            ...
            <div class="tml-nav">
                <ul class="nav nav-tabs">
                    <li><a href="<?=DEFAULT_URL."/".SITEMGR_ALIAS."/"?>" data-placement="bottom" title="<?=system_showText(LANG_SITEMGR_TIMELINE_ALL);?>" class="list-group-item <?=(!$where? "active" : "")?>"><?=system_showText(LANG_SITEMGR_ALL);?><?=($totalNew["total"] ? "<span class=\"label label-warning\">".$totalNew["total"]."</span>" : "")?></a></li>
                    ...
                    <li><a href="<?=DEFAULT_URL."/".SITEMGR_ALIAS."/?where=general"?>" id="t-general" data-placement="bottom" title="<?=system_showText(LANG_SITEMGR_TIMELINE_GENERAL);?>" class="list-group-item <?=($where == "general" ? "active" : "")?>"><?=system_showText(LANG_SITEMGR_GENERAL);?><?=($totalNewGeneral["total"] ? "<span class=\"label label-warning\">".$totalNewGeneral["total"]."</span>" : "")?></a></li>
                    
                    <? } ?>
                    
                    <? if (permission_hasSMPermSection(SITEMGR_PERMISSION_CONTENT)) { ?>
                    
                        <li><a href="<?=DEFAULT_URL."/".SITEMGR_ALIAS."/?where=listing"?>" class="list-group-item <?=($where == "listing" ? "active" : "")?>"><?=system_showText(LANG_LISTING_FEATURE_NAME_PLURAL);?><?=($totalNewListing["total"] ? "<span class=\"label label-warning\">".$totalNewListing["total"]."</span>" : "")?></a></li>

                        <? if (PROMOTION_FEATURE == "on" && CUSTOM_PROMOTION_FEATURE == "on" && CUSTOM_HAS_PROMOTION) { ?>
                        <li><a href="<?=DEFAULT_URL."/".SITEMGR_ALIAS."/?where=promotion"?>" id="t-promotion" class="list-group-item <?=($where == "promotion" ? "active" : "")?>"><?=system_showText(LANG_PROMOTION_FEATURE_NAME_PLURAL);?><?=($totalNewDeal["total"] ? "<span class=\"label label-warning\">".$totalNewDeal["total"]."</span>" : "")?></a></li>
                        <? } ?>

                        <? if (BANNER_FEATURE == "on" && CUSTOM_BANNER_FEATURE == "on") { ?>
                        <li><a href="<?=DEFAULT_URL."/".SITEMGR_ALIAS."/?where=banner"?>" id="t-banner" class="list-group-item <?=($where == "banner" ? "active" : "")?>"><?=system_showText(LANG_BANNER_FEATURE_NAME_PLURAL);?><?=($totalNewBanner["total"] ? "<span class=\"label label-warning\">".$totalNewBanner["total"]."</span>" : "")?></a></li>
                        <? } ?>

                        <? if (EVENT_FEATURE == "on" && CUSTOM_EVENT_FEATURE == "on") { ?>
                        <li><a href="<?=DEFAULT_URL."/".SITEMGR_ALIAS."/?where=event"?>" id="t-event" class="list-group-item <?=($where == "event" ? "active" : "")?>"><?=system_showText(LANG_EVENT_FEATURE_NAME_PLURAL);?><?=($totalNewEvent["total"] ? "<span class=\"label label-warning\">".$totalNewEvent["total"]."</span>" : "")?></a></li>
                        <? } ?>

                        <? if (CLASSIFIED_FEATURE == "on" && CUSTOM_CLASSIFIED_FEATURE == "on") { ?>
                        <li><a href="<?=DEFAULT_URL."/".SITEMGR_ALIAS."/?where=classified"?>" id="t-classified" class="list-group-item <?=($where == "classified" ? "active" : "")?>"><?=system_showText(LANG_CLASSIFIED_FEATURE_NAME_PLURAL);?><?=($totalNewClassified["total"] ? "<span class=\"label label-warning\">".$totalNewClassified["total"]."</span>" : "")?></a></li>
                        <? } ?>

                        <? if (ARTICLE_FEATURE == "on" && CUSTOM_ARTICLE_FEATURE == "on") { ?>
                        <li><a href="<?=DEFAULT_URL."/".SITEMGR_ALIAS."/?where=article"?>" id="t-article" class="list-group-item <?=($where == "article" ? "active" : "")?>"><?=system_showText(LANG_ARTICLE_FEATURE_NAME_PLURAL);?><?=($totalNewArticle["total"] ? "<span class=\"label label-warning\">".$totalNewArticle["total"]."</span>" : "")?></a></li>
                        <? } ?>
