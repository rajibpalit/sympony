                                                ...
                                                <tbody>
                                                    ...
                                                    <? if(count($report[$module]['keywords']) > 0) { ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <? echo "<img src='http://chart.googleapis.com/chart?chs=350x170&amp;chf=bg,s,ffffff&amp;cht=p&amp;chd=t:", implode(',', $percentList),"&amp;chl=", implode('|', $labelList),"&amp;chco=", implode(',', $colorList), "' alt='".system_showText(LANG_SITEMGR_REPORT_STATISTICCHART)."'/>"; ?>
                                                            </td>
                                                        </tr>
                                                    <? } else { ?>
                                                        <tr>
