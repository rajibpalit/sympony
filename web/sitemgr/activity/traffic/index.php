    ...
    <main class="wrapper togglesidebar container-fluid">
        ...
        <section class="well well-intro">
            ...
            <div class="row">
                ...
                <div class="col-sm-5 col-xs-9">
                    <h2><?= ucfirst(system_showText(LANG_SITEMGR_REVIEWS))." & ".system_showText(LANG_CHECKINCOUNT_PLURAL) ?></h2>
                    <p><?=system_showText(LANG_SITEMGR_TRAFFIC_3);?></p>
                    <a href="<?=DEFAULT_URL."/".SITEMGR_ALIAS."/activity/reviews-comments/"?>" class="btn btn-info"><?= ucfirst(system_showText(LANG_SITEMGR_REVIEWS))." & ".system_showText(LANG_CHECKINCOUNT_PLURAL) ?></a>
                </div>
