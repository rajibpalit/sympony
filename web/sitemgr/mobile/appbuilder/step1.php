<?php
    ...
    */
    ...
    # ----------------------------------------------------------------------------------------------------
	# * FILE: /ed-admin/mobile/appbuilder/step1.php
	# ----------------------------------------------------------------------------------------------------
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if (!$name) {
            ...
            header("Location: ".DEFAULT_URL."/".SITEMGR_ALIAS."/mobile/appbuilder/".($next == "yes" ? "step2.php" : "step1.php?success=1"));
            exit;
        }
    }
        ...
        <section class="row appbuilder">
            ...
            <div class="appbuilder-container">
                ...
                <section class="container">
                    ...
                    <p class="subheading"><?=system_showText(LANG_SITEMGR_CONFIGURE_APP_STEP_10_MSG)?></p>
