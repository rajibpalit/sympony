<?php
    ...
    */
    ...
    # ----------------------------------------------------------------------------------------------------
	# * FILE: /ed-admin/mobile/appbuilder/step5.php
	# ----------------------------------------------------------------------------------------------------
        ...
        <section class="row appbuilder">
            <div class="appbuilder-container">
                ...
                <section class="container">
    				<h4><?=system_showText(LANG_SITEMGR_CUSTOMPAGES_TITLE);?></h4>

                    <p class="subheading"><?=system_showText(LANG_SITEMGR_CUSTOMPAGES_SUBHEADING1);?></p>
                    <p class="subheading"><?=system_showText(LANG_SITEMGR_CUSTOMPAGES_SUBHEADING2);?></p>
                    ...
                    <div class="action">
                        <button id="nextbutton" type="button" class="btn btn-primary"><?=system_showText(LANG_SITEMGR_NEXT);?></button>
                    </div>
