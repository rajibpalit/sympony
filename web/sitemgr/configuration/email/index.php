<?php
    ...
    */
	...
	if ($_SERVER['REQUEST_METHOD'] == "POST") {
        ...
        if (!$adminemail) {
            ...
            $yamlFile = array(
                ...
                'mailer_encryption' => $emailconf_protocol
            );
            ...
            if (validate_form("adminemail", $_POST, $message_adminemail)) {
                ...
                $sitemgr_lead_email = str_replace(" ", "", $sitemgr_lead_email);
				if (!setting_set("sitemgr_lead_email", $sitemgr_lead_email)) {
					if (!setting_new("sitemgr_lead_email", $sitemgr_lead_email)) {
						$error = true;
					}
				}
	...
	if (!$sitemgr_lead_email) setting_get("sitemgr_lead_email", $sitemgr_lead_email);
