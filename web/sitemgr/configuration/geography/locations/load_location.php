        ...
        if(!$location_link){
            ...
            foreach ($_aux_load_location_option as $_key => $_value) {
                ...
                for($i=1;$i<=5;$i++){
					...
					// Do insert in different way to Locations_4
					if($i == 4){
						$sql = "insert into `"._DIRECTORYDB_NAME."`.Location_".$i." (location_3, location_2, location_1, name, abbreviation, friendly_url, seo_description, seo_keywords) select location_3, location_2, location_1, name, abbreviation, friendly_url, seo_description, seo_keywords from ".$country_model_db.".Location_".$i;
					}else{
						$sql = "insert into `"._DIRECTORYDB_NAME."`.Location_".$i." select * from ".$country_model_db.".Location_".$i;
					}
