<?
    ...
    */
    ...
    # ----------------------------------------------------------------------------------------------------
	# * FILE: /ed-admin/configuration/geography/locations/location_2/location_2.php
	# ----------------------------------------------------------------------------------------------------
			...
			<section class="row tab-options">
                ...
                <div class="container">
                    <div class="pull-right top-actions">
                        <a href="<?=$url_base."/locations/location_2/index.php?".($_location_node_params?$_location_node_params : "")?>" class="btn btn-default btn-xs"><?=system_showText(LANG_CANCEL)?></a>
