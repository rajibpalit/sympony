           ...
           <section class="row edit-listing">
	           	<div class="container">
                    ...
                    if ($nav_page == 1) {
                        ...
                        include(INCLUDES_DIR."/forms/form-email2.php");
                    }
                    ?>
	           	</div>
           </section>
           ...
           <section class="row footer-action">
           		<div class="container">
	           		<div class="col-xs-12 text-right">
						...
						<button type="submit" name="next" value="<?=system_showText(LANG_SITEMGR_NEXT)?>" class="btn btn-primary action-save" data-loading-text="<?=system_showText(LANG_LABEL_FORM_WAIT);?>"><?=system_showText(LANG_SITEMGR_NEXT)?></button>
                        <? } elseif ($nav_page == 2) { ?>
                        <button type="button" name="back" value="<?=system_showText(LANG_SITEMGR_BACK)?>" onclick="JS_Back();" class="btn btn-default"><?=system_showText(LANG_SITEMGR_BACK)?></button>
	           			<span class="separator"> <?=system_showText(LANG_OR)?> </span>
