...
?>
    ...
    <div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="navbar-header navbar-left">
            ...
            <a  id="navBrand" class="<?=(sess_isSitemgrLogged() && string_strpos($_SERVER["PHP_SELF"], "resetpassword.php") === false && string_strpos($_SERVER["PHP_SELF"], "setlogin.php") === false ? "admin-logo" : "logo-nologin")?>" href="<?=DEFAULT_URL?>/<?=SITEMGR_ALIAS?>/" target="_parent" <?=(trim(EDIRECTORY_TITLE) ? "title=\"".EDIRECTORY_TITLE."\"" : "")?>>
