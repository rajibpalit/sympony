        ...
        <div class="second-sidebar">
            ...
            <div class="navigation nano">
                <div class="list-group nano-content">
                    ...
                    <? } ?>
                    <a href="<?=DEFAULT_URL."/".SITEMGR_ALIAS."/configuration/wordpress/"?>" class="list-group-item <?=(string_strpos($_SERVER["PHP_SELF"], "/configuration/wordpress") !== false ? "active" : "")?>"><?=system_showText(LANG_SITEMGR_INTEGRATION_WORDPRESS);?></a>
                    <? if (SUGARCRM_FEATURE == "on") { ?>
                    <a href="<?=DEFAULT_URL."/".SITEMGR_ALIAS."/configuration/sugarcrm/"?>" class="list-group-item <?=(string_strpos($_SERVER["PHP_SELF"], "/configuration/sugarcrm") !== false ? "active" : "")?>">SugarCRM</a>
                    <? } ?>
