<?php
    ...
    */
    ...
    # ----------------------------------------------------------------------------------------------------
	# * FILE: /ed-admin/layout/nav-tabs-content-classified.php
	# ----------------------------------------------------------------------------------------------------
...
?>
    ...
    <ul class="nav nav-tabs pull-left" role="tablist">
        <li <?= $activeTab['classified']; ?>>
            <a href="<?=$url_redirect?>/classified.php?id=<?=$id?>" role="tab"><?=system_showText(LANG_SITEMGR_LISTINGTEMPLATE_EDITINFORMATION);?></a>
        </li>
