        ...
        <div class="second-sidebar">
            ...
            <div class="navigation nano">
                <div class="list-group nano-content">
                    ...
                    <a href="<?=DEFAULT_URL."/".SITEMGR_ALIAS."/content/pages/"?>" class="list-group-item <?=(string_strpos($_SERVER["PHP_SELF"], "/content/pages/") !== false ? "active" : "")?>"><?=system_showText(LANG_SITEMGR_CONTENT_PAGES);?></a>

                    <a href="<?=DEFAULT_URL."/".SITEMGR_ALIAS."/content/slider/"?>" class="list-group-item <?=(string_strpos($_SERVER["PHP_SELF"], "/content/slider/") !== false ? "active" : "")?>"><?=system_showText(LANG_SITEMGR_NAVBAR_SLIDER);?></a>
