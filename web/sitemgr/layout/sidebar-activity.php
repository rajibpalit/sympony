        ...
        <div class="second-sidebar">
            ...
            <div class="navigation nano">
                <div class="list-group nano-content">
                    ...
                    <a href="<?=DEFAULT_URL."/".SITEMGR_ALIAS."/activity/reviews-comments/"?>" class="list-group-item <?=(string_strpos($_SERVER["PHP_SELF"], "/activity/reviews-comments/") !== false ? "active" : "")?>"><?= ucfirst(system_showText(LANG_SITEMGR_REVIEWS))." & ".system_showText(LANG_CHECKINCOUNT_PLURAL) ?></a>
