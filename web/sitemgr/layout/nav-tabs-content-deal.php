<?php
    ...
    */
    ...
    # ----------------------------------------------------------------------------------------------------
	# * FILE: /ed-admin/layout/nav-tabs-content-deal.php
	# ----------------------------------------------------------------------------------------------------
...
?>
    ...
    <ul class="nav nav-tabs pull-left" role="tablist">
        <li <?= $activeTab['deal']; ?>>
            <a href="<?=$url_redirect?>/deal.php?id=<?=$id?>" role="tab"><?=system_showText(LANG_SITEMGR_LISTINGTEMPLATE_EDITINFORMATION);?></a>
        </li>
