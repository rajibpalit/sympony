...
?>
    ...
    <html lang="<?=system_getHeaderLang();?>">
        ...
        <head>
            ...
            <!-- THEME STYLE -->
            <link href="<?=DEFAULT_URL;?>/assets/css/style.css" rel="stylesheet" type="text/css" media="all" />
                    ...
                    <div class="collapse navbar-collapse">
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <?php if (sess_getAccountIdFromSession()) { ?>
                                ...
                                <? } else { ?>
                                        <li><a href="<?=DEFAULT_URL?>/<?=MEMBERS_ALIAS?>/" class="btn btn-success"><?=(LANG_MEMBERS_DASHBOARD)?></a></li>
                                <? } ?>
                            ...
                            <? } else { ?>
                                ...
                                <li><a href="/sponsors" class="btn btn-success"><?=(LANG_LABEL_LOGIN_SPONSORAREA)?></a></li>
                            <? } ?>
                    ...
                    <div class="container">
                        ...
                        <nav class="navbar">
                            ...
                            <div class="collapse navbar-collapse" id="main-navbar">
                                <? include(system_getFrontendPath("header_menu.php", "frontend")); ?>
